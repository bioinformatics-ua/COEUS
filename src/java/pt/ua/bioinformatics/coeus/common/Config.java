...
public class Config {
     ...
     *      <li><stong>setup</strong> seed setup file named (located on source path root)</li>
     *      <li><stong>debug</strong> debug mode on/off</li>
     *      <li><stong>built</strong> seed built/not built</li>
     *      <li><stong>predicates</strong> seed predicate list (static for performance reasons)</li>
     *      <li><stong>environment</strong> seed environment mode (development, testing, production; must match coeus_sdb_*.ttl filename)</li>
