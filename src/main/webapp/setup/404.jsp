        ...
        <body>
            <div class="jumbotron center">
                ...
                <p>The page you requested could not be found, either contact your webmaster
                    or try again.</p>
                <p>Use your browsers <b>Back</b> button to navigate to the page you have prevously
                    come from</p>
                <p><b>Or you could just press this button:</b>
                </p> <a href="/coeus/" class="btn btn-lg btn-info"><i class="glyphicon glyphicon-home icon-white"></i> Take Me Home</a>
            </div>
            <br />
        </body>
