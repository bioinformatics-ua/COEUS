            ...
            <div class="modal-body">
                ...
                <p class="lead" >URI - <span class="lead text-info" id="uri" data-toggle="tooltip" title="A URI is formed when you fill the title box." >coeus: </span></p>
                    ...
                    <div id="titleForm" class="form-group">
                        ...
                        <input class="form-control tip" data-toggle="tooltip" title="The title (dc:title) property." id="title" type="text" placeholder="Ex: Uniprot" onkeyup="changeURI('uri', $('#addType').html(), this.value);" autofocus> 
                    </div>
                    <div id="labelForm" class="form-group">
                        <label class="control-label" for="label">Label</label>
                        <input class="form-control tip" data-toggle="tooltip" title="The label (rdfs:label) property." id="label" type="text" placeholder="Ex: Uniprot"> 
                    </div>
                    <div id="commentForm" class="form-group">
                        <label class="control-label" for="comment">Comment</label>
                        <textarea class="form-control tip" data-toggle="tooltip" title="The comment (rdfs:comment) property." rows="4" id="comment" type="text" placeholder="Ex: Describes the Uniprot..."></textarea> 
                    </div>
