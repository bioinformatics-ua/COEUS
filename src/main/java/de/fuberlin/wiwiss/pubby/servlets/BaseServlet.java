 ...
 * This class handles preprocessing of the request to extract the resource URI
 * relative to the namespace root, and manages the {@link Configuration}
 * instance shared by all servlets.
 *
