...
public class FOAF {
    ...
    /**
     * <p>A phone, specified using fully qualified tel: URI scheme (refs:
     * http://www.w3.org/Addressing/schemes.html#tel).</p>
     */
    ...
    /**
     * <p>The birthday of this Agent, represented in mm-dd string form, eg.
     * '12-31'.</p>
     */
    public static final Property birthday = m_model.createProperty("http://xmlns.com/foaf/0.1/birthday");
    /**
     * <p>An image that can be used to represent some thing (ie. those
     * depictions which are particularly representative of something, eg. one's
     * photo on a homepage).</p>
     */
    ...
    /**
     * <p>A tipjar document for this agent, describing means for payment and
     * reward.</p>
     */
    ...
    /**
     * <p>The sha1sum of the URI of an Internet mailbox associated with exactly
     * one owner, the first owner of the mailbox.</p>
     */
    public static final Property mbox_sha1sum = m_model.createProperty("http://xmlns.com/foaf/0.1/mbox_sha1sum");
    /**
     * <p>A textual geekcode for this person, see
     * http://www.geekcode.com/geek.html</p>
     */
    ...
    /**
     * <p>A person known by this person (indicating some level of reciprocated
     * interaction between the parties).</p>
     */
    ...
    /**
     * <p>A workplace homepage of some person; the homepage of an organization
     * they work for.</p>
     */
    public static final Property workplaceHomepage = m_model.createProperty("http://xmlns.com/foaf/0.1/workplaceHomepage");
    /**
     * <p>A location that something is based near, for some broadly human notion
     * of near.</p>
     */
    ...
    /**
     * <p>A work info homepage of some person; a page about their work for some
     * organization.</p>
     */
    ...
    /**
     * <p>The gender of this Agent (typically but not necessarily 'male' or
     * 'female').</p>
     */
    public static final Property gender = m_model.createProperty("http://xmlns.com/foaf/0.1/gender");
    /**
     * <p>A personal mailbox, ie. an Internet mailbox associated with exactly
     ...
     * one individual that ever has any particular value for foaf:mbox.</p>
     */
    ...
    /**
     * <p>A short informal nickname characterising an agent (includes login
     * identifiers, IRC and other chat nicknames).</p>
     */
