...
public class Assertion {
    ...
    private void init() {
        Triple type = new Triple(Node.createURI(id), Node.createURI(Predicate.get("rdf:type").getURI()), Node.createURI(PrefixFactory.getURIForPrefix("np") + "Assertion"));
        add(type);
    }
