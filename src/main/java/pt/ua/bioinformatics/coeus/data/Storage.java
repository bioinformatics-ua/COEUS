 ...
 * <p>Storage relies on Jena internal methods and structure.<br />For further
 * information please check Jena's documentation</p>
 * </p>
 *
 * @author pedrolopes
 */
public class Storage {
     ...
     * <p>
     * Connection information must be available in JS configuration file,
     * <strong>sdb</strong> property.
     * </p>
     *
     ...
     * <p>
     * Base COEUS ontology must be available in JS configuration file,
     * <strong>ontology</strong> property.
     * </p>
     *
     * @return success of the operation.
     */
     ...
     * <p>
     * Setup information must be available in JS configuration file,
     * <strong>setup</strong> property.
     * </p>
     *
     * @return success of the operation.
     */
...
//                infmodel = ModelFactory.createInfModel(reasoner, model);
    ...
    /**
     * Loads COEUS Data Predicate information to Predicate singleton for further
     * usage.
     * <p><b>Workflow</b><ol>
