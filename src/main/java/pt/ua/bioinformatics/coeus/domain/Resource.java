 ...
 * <p>A Resource is any referenced external system, whether app, database or
 * service.<br />Resource class instances are used to configure data loading
...
public class Resource {
    ...
    /**
     * Loads individuals from the Concept that this Resource extends, based on
     * given extension property.
     *
     * @return an ArrayList<String> containing Concept individual URIs.
     */
    ...
    /**
     * Loads information for the Concept individual associated with the
     * Resource.
     *
     * @return success of the operation.
     */
