...
/**
 * Handles mappings for COEUS CSV, SQL, SPARQL and XML Resource types
 * individuals.
 * <p>This InheritedResource data type permits having a single general class for
 * every external Resource, simplifying data import code.
 * </p>
 *
 * @author pedrolopes
 */
