 ...
 * @author pedrolopes
 */
@UrlBinding("/api/{apikey}/simple/write/{sub}/{pred}/{obj}")
public class SimpleWriteActionBean implements ActionBean {
            ...
            if (sub.indexOf(":") > 1) {
                try {
                    ...
                    if (Config.isDebug()) {
                        ...
                        Logger.getLogger(SimpleWriteActionBean.class.getName()).log(Level.SEVERE, null, ex);
                    }
